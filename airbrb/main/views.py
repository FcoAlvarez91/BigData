...
def graph4(response):
	...
	#istambul_ Genera error de NONE
	#query.append("select istambul_.procedence, istambul_lista_reducida_.number_of_reviews, avg(istambul_.price) from istambul_lista_reducida_ join  istambul_ on istambul_lista_reducida_.id = istambul_.listing_id group by  istambul_lista_reducida_.number_of_reviews, istambul_.procedence ")
